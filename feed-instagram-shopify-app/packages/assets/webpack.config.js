...
if (!isProduction && process.env.SHOPIFY_API_KEY) {
  try {
    ...
    fs.readFile(runtimeFile, 'utf8', (err, data) => {
      ...
      configData.instagram.id = process.env.INSTAGRAM_APP_ID;
      configData.instagram.secret = process.env.INSTAGRAM_APP_SECRET;
      configData.instagram.redirect_uri = process.env.APP_REDIRECT_URL;
